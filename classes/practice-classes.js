...
class Player extends Character {
  ...
  defend(amount) {
    ...
    // console.log('Player -> defend -> this.healthLevel -= amount', this.healthLevel -= amount)
...
fireSpitter.addSuperPower('flying fire fury')
fireSpitter.addSuperPower('tail whip')
